...
export const LiquidChrome: React.FC<LiquidChromeProps> = ({
  ...
  secondaryColor = [0.29, 0.56, 0.89],
  thirdColor = [0.42, 0.27, 0.76],
  midColor = [0.02, 0.71, 0.83],
  speed = 0.2,
  amplitude = 0.5,
  frequencyX = 3.3,
  frequencyY = 2.2,
  ...
  }, [baseColor, speed, amplitude, frequencyX, frequencyY, interactive, midColor, secondaryColor, thirdColor]);

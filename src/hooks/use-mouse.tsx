...
/**
 * Hook to track the mouse position and the position of the element relative to the container
 * @param containerRef - Reference to the container element
 * @returns [state, ref] - State and reference to the container element
 */
